...
class Renderer2D(gc: GraphicsContext, blockSize: Double) {
  ...
  private val floorImage = Renderer2D.loadImage("/blue.png")
  private val wallImage = Renderer2D.loadImage("/purple.png")
  private val playerImage = Renderer2D.loadImage("/ratIcon.png")
  private val enemyImage = Renderer2D.loadImage("/catIcon.png")
  private val generatorImage = Renderer2D.loadImage("/catnip.png")
  private val bulletImage = Renderer2D.loadImage("/mouseTrap.png")
...
object Renderer2D {
  ...
  def loadImage(path: String): Image = {
    ...
    if(res == null) {
      new Image("file:/users/awalker3/Downloads"+path)
    } else {
